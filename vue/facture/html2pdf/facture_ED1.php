<?php
		...
		#page {
		  ...
		  margin:auto;
		  padding:20px;
		  background-image: url("vue/images/back.jpg");
		...
		<div id="page">
			  ...
			  <img src="vue/images/ed.png" width="70" > 
			    ...
			    <br><br>
			    <p align="right"> <strong>Num facture: </strong>'.$nof.'</p>
			   </div>
			   ...
			   <div id="address">
			    ...
			    <p>
			      ...
			      Adresse:'. $_SESSION['user']['adresse'].' '.$_SESSION['user']['ville'].'<br>
			    ...
			    <table>
			      ...
			      ';
			      	...
			      	for( $i = 0 ;$i < count($produits) ;$i++)
			      	{
			      			...
			      			$content .='">
			      			  <td> Produit: '.($i+1).'</td>
			      			  <td>'.get_qtc($produits[$i]['NOP']).'</td>
			      			  <td>'.$produits[$i]['PU'].'</td>
			      			  <td>'.sous_total($produits[$i]).'</td>
			      			</tr>';
    	...
    	include_once('vue/facture/html2pdf_v4.03/html2pdf.class.php');
